...
export async function POST(request: Request) {
  ...
  const text = [
    greeting,
    "",
    "Thank you for joining the Òye Community waitlist. That decision - to put your name down for a community that's about honesty, not performance - already says something about the kind of marriage you're building.",
    "",
    "Òye Community is a monthly community for couples and individuals who want ongoing, honest conversation about the real patterns inside marriage. Not a course. Not a programme with an end date. A room that stays open.",
    "",
    ...
    "",
    `Òye Community isn't just a community name, ${firstName || "love"}. It's a daily decision. And you've already started making it.`,
    "",
    "With warmth,",
    "Tobi",
  ].join("\n");
