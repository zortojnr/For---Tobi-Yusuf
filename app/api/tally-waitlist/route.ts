...
export async function POST(request: Request) {
  ...
  const text = [
    ...
    "→ Follow me on Instagram. I share marriage reflections, relatable moments, and behind-the-scenes of what I'm building. @MrsTobiYusuf (link: https://www.instagram.com/mrstobiyusuf)",
    "",
    "→ Read the Sunday reflections, every week I write honestly about patterns I see in marriages. Subscribe on Substack. (link: https://substack.com/@mrstobiyusuf)",
    "",
    "→ Book a Marriage Reflection Call if you feel like you need a conversation sooner, this is a private 60-minute session for you and your partner. It's not therapy. It's one honest conversation with someone who understands. £295/couple. (link: https://therelatablewife.as.me/)",
    "",
    "→ Listen to the Love Reset Audio a free 5-day audio experience to help you breathe, refocus, and reconnect. (link: https://www.tobiyusuf.com/)",
    "",
    "",
